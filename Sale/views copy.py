...
def store(request,id):
    ...
    sale = Sale()
    if 'invoiceID' in request.session:
        sale.invoiceId = request.session['name']
        sale.cus_name  = request.session['cus_name']
        sale.method    = request.session['method']
        sale.contact   = request.session['contact']
        sale.dob       = request.session['dob']
        sale.address   = request.session['address']
    else:
